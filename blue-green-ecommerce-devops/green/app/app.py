...
PRODUCTS = [
    ...
    {"id": 4, "name": "Smartwatch",  "price": 8000,  "icon": "⌚"},
]

ENV = "GREEN"
VERSION = "2"
SALE_BANNER = "🔥 20% Discount Sale"

@app.route("/")
def home():
    return render_template("index.html", products=PRODUCTS, env=ENV, version=VERSION, banner=SALE_BANNER)
